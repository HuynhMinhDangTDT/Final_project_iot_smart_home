...
def switch_camera(current_camera, cap1, cap2):
    return cap2 if current_camera == cap1 else cap1
...
def fire_detection(Input_ip_text, Input_username_text, Input_password_text, Input_email_receiver_text):
    ...
    current_camera = cap1
    # current_camera = switch_camera(current_camera, cap1, cap2)
...
def UI_UX_Aplication():
    ...
    Input_email_receiver_label = tk.Label(frame1, text='Input email receiver', font=(
